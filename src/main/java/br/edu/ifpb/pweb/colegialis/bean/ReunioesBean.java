...
public class ReunioesBean {
	...
	public void init(){
		...
		pf1 = new Processo("Solicitação de trancamento de matricula por aluno Aaron Santos", p2, true, true, 5, 0);
		pf2 = new Processo("Solicitação de reaproveitamento de disciplina por aluno Gesoaldo", p5, true, true, 3, 2);
		pf3 = new Processo("Solicitação de trancamento de matricula por aluna Larissa Moreira", p6, true, true, 4, 1);
